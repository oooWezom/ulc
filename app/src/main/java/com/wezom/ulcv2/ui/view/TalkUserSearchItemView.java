 ...
 */
public class TalkUserSearchItemView extends RelativeLayout implements ViewModel<Profile> {
    ...
    public TalkUserSearchItemView(Context context, EventBus bus) {
        super(context);
        init(context);
        mBus = bus;
    }

    public TalkUserSearchItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    public void onClick() {
        ...
        user.setSex(mData.getSex());
        user.setLevel(mData.getLevel());
        user.setExp((int) mData.getExp());
        user.setLikes(mData.getLikes());
        user.setAvatar(mData.getAvatar());
        user.setStatus(mData.getStatus());


        mBus.post(new AddUserToTalkEvent(user));
    }
